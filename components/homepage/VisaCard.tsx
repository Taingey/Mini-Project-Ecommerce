...
const VisaCard = () => {
  return (
    <div className="">
      <div className="mx-auto container flex justify-center py-16 px-4 lg:flex-col">
        <div className="flex flex-col space-y-8 w-full pr-5 max-w-xl">
          <div className="flex items-center justify-between bg-gradient-to-tl from-gray-900 to-gray-800 text-white h-56 w-96 p-6 rounded-xl shadow-md">
          ...
          <div className="relative">
            <div className="absolute right-10 flex space-x-2 items-start bg-white text-black border-gray-200 shadow-2xl -mt-16 w-72 px-2 py-3 rounded-lg dark:bg-[#05342d] dark:text-white">
              ...
              <div className="flex-1 font-Staatliches  inline-flex items-start justify-between">
                <div>
        ...
        <div className=" w-full font-Staatliches mt-5 text-[black] dark:text-white">
          <h1 className="text-4xl tracking-wider">VISA Card</h1>
          <p className="mt-3 tracking-wider">
            Using your VISA card at Cambo Store is easy. Simply add your desired
            items to your cart, proceed to checkout, and select VISA as your
            payment method. Enter your card details, including the card number,
            expiration date, and CVV code, and confirm your purchase. It's that
            simple!
          </p>
        </div>
      </div>
